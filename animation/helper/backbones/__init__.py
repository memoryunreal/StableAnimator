from animation.helper.backbones.iresnet import iresnet18, iresnet34, iresnet50, iresnet100, iresnet200
from animation.helper.backbones.mobilefacenet import get_mbf


def face_embedding_extractor_get_model(name, **kwargs):
    # resnet
    if name == "r18":
